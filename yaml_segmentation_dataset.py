...
class YAMLSegmentationDataset_2D(data.Dataset):
    ...
    def __init__(self, dataset='/nas/softechict-nas-2/fresearchers/data/prostate/prostate.yml',
...
if __name__ == '__main__':
    ...
    yaml_f = '/nas/softechict-nas-2/fresearchers/data/prostate/prostate.yml'
